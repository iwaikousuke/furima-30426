class OrderPurchase
  ...
  validates :prefecture_id, numericality: { other_than: 1 }
    def save
      ...
      Address.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, street_address: street_address, phone_number: phone_number, building: building, purchase_id: purchase_id)
    end
end